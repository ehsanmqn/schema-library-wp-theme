...
function omh_schema_library_theme_scripts() {
  ...
  wp_enqueue_script( 'omh-schema-library-script', get_template_directory_uri() . '/js/omh-schema-library-functions.js', array( 'jquery','angular','moment','omh-documentation-utilities-script' ) );
